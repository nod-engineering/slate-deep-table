...
function mergeCell(opts, editor, mergeOptions) {
  ...
  if (
    ...
    if (
      ...
      firstCellData["mergeDirection"] = firstCellData.mergeDirection ? Object.assign(firstCellData.mergeDirection, {[direction]: true}) : {[direction]: true};
      ...
      editor.withoutNormalizing(() => {
        nextCells.forEach((nextCell) => {
          ...
          nextCellData["mergeDirection"] = nextCellData.mergeDirection ? Object.assign(nextCellData.mergeDirection, {[direction]: true}) : {[direction]: true};
