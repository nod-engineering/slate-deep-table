   ...
   */
    ...
    function canMergeRight(editor) {
        ...
        if (
          ...
          ((!cellToMerge.data.get('rowspan') &&
            selectedCell.data.get('rowspan') === 1) ||
            (!selectedCell.data.get('rowspan') &&
              cellToMerge.data.get('rowspan') === 1) ||
            cellToMerge.data.get('rowspan') === selectedCell.data.get('rowspan'))
        ) {
            return true;
        } else return false;
    }
    ...
    function canMergeDown(editor) {
        ...
        if (rowToMerge) {
            ...
            if (
                cellToMerge &&
              !cellToMerge.data.get('isMerged') &&
              ((!cellToMerge.data.get('colspan') &&
                selectedCell.data.get('colspan') === 1) ||
                (!selectedCell.data.get('colspan') &&
                  cellToMerge.data.get('colspan') === 1) ||
                cellToMerge.data.get('colspan') === selectedCell.data.get('colspan'))
            ) {
                return true;
            } else return false;
        }
