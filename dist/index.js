    ...
    */
    ...
    function canMergeRight(editor) {
        ...
        if (value && startBlock) {
            ...
            if (cellToMerge && !cellToMerge.data.get('isMerged') && (!cellToMerge.data.get('rowspan') || cellToMerge.data.get('rowspan') === 1) && (!selectedCell.data.get('rowspan') || selectedCell.data.get('rowspan') === 1) && !(cellToMerge.data.get('colspan') > 1) && !(selectedCell.data.get('colspan') > 1)) {
                return true;
            }
        }
        return false;
    ...
    function canMergeDown(editor) {
        ...
        if (value && startBlock) {
            ...
            if (rowToMerge) {
                ...
                if (cellToMerge && !cellToMerge.data.get('isMerged') && (!cellToMerge.data.get('colspan') || cellToMerge.data.get('colspan') === 1) && (!selectedCell.data.get('colspan') || selectedCell.data.get('colspan') === 1) && !(cellToMerge.data.get('rowspan') > 1) && !(selectedCell.data.get('rowspan') > 1)) {
                    return true;
                }
            }
        }
